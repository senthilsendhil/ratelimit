...
public class SlidingWindowCounterRateLimiter implements RateLimiter {
    ...
    public boolean shouldAllowServiceCall(String userId) {
        ...
        synchronized (userTimestamps) {
            ...
            System.out.println(userId + " : total request count : " + userTimestamps.getTotalCounts().get());
            ...
            System.out.println(userId + " : request number : " + userTimestamps.getTotalCounts().get() + " allowed");
        }
        return true;
    }
